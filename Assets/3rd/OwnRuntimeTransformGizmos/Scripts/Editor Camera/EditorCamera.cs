...
namespace RTEditor
{
    ...
    public class EditorCamera : MonoSingletonBase<EditorCamera>
    {
        ...
        [SerializeField]
        protected ShortcutKeys _focusOnSelectionShortcut = new ShortcutKeys("Focus on selection", 1)
        {
            Key0 = KeyCode.F,
            UseModifiers = false,
        ...
        [SerializeField]
        protected ShortcutKeys _cameraLookAroundShortcut = new ShortcutKeys("Camera look around", 0)
        {
            UseModifiers = false,
            RMouseButton = true
        };
        [SerializeField]
        protected ShortcutKeys _cameraOrbitShortcut = new ShortcutKeys("Camera orbit", 0)
        {
            LAlt = true,
            RMouseButton = true
        };
        ...
        /// </summary>
        [SerializeField]
        protected EditorCameraZoomSettings _zoomSettings = new EditorCameraZoomSettings();
        ...
        /// </summary>
        [SerializeField]
        protected EditorCameraFocusSettings _focusSettings = new EditorCameraFocusSettings();
        ...
        /// </summary>
        [SerializeField]
        protected float _rotationSpeedInDegrees = 8.8f;
        ...
        /// </summary>
        protected bool _wasFocused = false;
        protected Vector3 _lastFocusPoint = Vector3.zero;
        ...
        /// </summary>
        protected float _orbitOffsetAlongLook = 0.0f;
        ...
        /// </summary>
        protected bool _applicationJustGainedFocus;

        protected float _initialNearClipPlane;
        protected bool _isDoingPerspectiveSwitch = false;

        private bool _isObjectVisibilityDirty = true;
        private HashSet<GameObject> _visibleGameObjects = new HashSet<GameObject>();

        [SerializeField]
        protected EditorCameraBk _background = new EditorCameraBk();
        #endregion
        ...
        /// </summary>
        protected void ApplyCameraZoomBasedOnUserInput()
        {
            // Ugly, ugly, ugly!!!
        ...
        /// </summary>
        protected void PanCameraBasedOnUserInput()
        {
        ...
        /// </summary>
        protected void RotateCameraBasedOnUserInput()
        {
        ...
        /// </summary>
        protected void MoveCameraBasedOnUserInput()
        {
        ...
        /// </summary>
        protected void CalculateOrbitOffsetAlongLook(EditorCameraFocusOperationInfo focusOpInfo)
        {
        ...
        /// </summary>
        protected IEnumerator StartConstantFocusOnSelection()
        {
            // Store needed data
            EditorCameraFocusOperationInfo focusOpInfo = EditorCameraFocus.GetFocusOperationInfo(Camera, _focusSettings);
            _lastFocusPoint = focusOpInfo.FocusPoint;
        ...
        protected IEnumerator StartAlignLookWithWorldAxis(Axis worldAxis, bool negativeAxis, float duration)
        {
