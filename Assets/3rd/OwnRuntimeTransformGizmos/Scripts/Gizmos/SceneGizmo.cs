...
namespace RTEditor
{
    public class SceneGizmo : MonoSingletonBase<SceneGizmo>
    {
        ...
        protected void OnFirstInputDeviceBtnDown()
        {
        ...
        protected int DetectHoveredComponent()
        {
        ...
        protected void EstablishComponentColors()
        {
        ...
        protected void UpdateGizmoCamera()
        {
